<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Report_MIS_SampleTested, App_Web_report_mis_sampletested.aspx.cdcab7d2" %>
            ...
            <table style="height: 100%; width: 90%;" cellspacing="5px">
                ...
                <tr>
                    <td colspan="5" style="width: 50%; border-width: 2px; border-color: Black; border-style: solid;
                        background-color: Gray;" id="tdPieSampleTested" runat="server">
                    </td>
                </tr>
            </table>
        </div>
